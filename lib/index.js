...
class Cadoose {
  ...
  constructor(_expressCassandra, clientOptions, ormOptions) {this._expressCassandra = null;this._directClient = null;this.models = {};this._defered = {};this.clientOptions = {};this.ormOptions = {};
  ...
  async _undeferModel(modelName, modelSchema, syncModel) {
