"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.ModelInstanceProxy = exports.BindModelInstance = exports.TransformInstanceValues = exports.ModelExprCassandraDummy = exports.ModelDummy = exports.Model = void 0;

var _bluebird = _interopRequireWildcard(require("bluebird"));var _async = _interopRequireDefault(require("async"));var _util = _interopRequireDefault(require("util"));
...
Model = /*#__PURE__*/function () {_createClass(Model, null, [{ key: "registerAndSync", value: function () {var _registerAndSync = (0, _bluebird.coroutine)(function* (
      ...
      name, schema, tablename) {
        ...
        const MyModel = yield cadoose().loadSchema(name, schema);
        yield MyModel.syncDBAsync();

        return MyModel;
      });function registerAndSync(_x, _x2, _x3) {return _registerAndSync.apply(this, arguments);}return registerAndSync;}() }, { key: "registerAndSyncDefered", value: function registerAndSyncDefered(
    name, schema, tablename) {
      if (tablename) {
        schema.options.table_name = tablename;
      }
  ...
  function Model(expressCassandraModel, schemaSchema) {var _this = this;_classCallCheck(this, Model);this._model = {};this._name = "";this._schema = {};this.Model = null;this.
    ...
    create = /*#__PURE__*/function () {var _ref = (0, _bluebird.coroutine)(function* (...models) {
        const arr = yield _bluebird.default.all(models.map(m => {
          const mod = new (cadoose().models[_this._name])(m);
...
ModelProxy = /*#__PURE__*/function (_Proxy) {_inherits(ModelProxy, _Proxy);

  function ModelProxy(expressCassandraRawModel, modelSchema) {_classCallCheck(this, ModelProxy);return _possibleConstructorReturn(this, _getPrototypeOf(ModelProxy).call(this,
    ((rawmodel, schema) => {
...
function ModelInstance(uid, instance, modelPrx) {var _this2 = this;_classCallCheck(this, ModelInstance);this._uid = null;this._instance = null;this.
  ...
  populate = /*#__PURE__*/function () {var _ref3 = (0, _bluebird.coroutine)(function* (prop) {
      const instProp = (0, _get.default)(_this2._instance, prop, null);
      ...
      const model = cadoose().models[_this2.constructor._properties.name];

      const ref = (0, _get.default)(model._schema.fields, `${prop}.ref`, null);
      if (ref) {
        ...
        if (refschema) {
          ...
          if (Array.isArray(instProp)) {
            ...
            const fetchedRefs = yield cadoose().models[ref].findAsync(_objectSpread2({}, queryObject));
            (0, _set.default)(_this2._instance, prop, fetchedRefs);
          } else
          {
            const queryObject = makeQueryObject(instProp);

            const fetchedRef = yield cadoose().models[ref].findOneAsync(_objectSpread2({}, queryObject));
            (0, _set.default)(_this2._instance, prop, fetchedRef);
          }
    ...
    });return function (_x6) {return _ref3.apply(this, arguments);};}();this._uid = uid;this._instance = instance;this.constructor = modelPrx;this.prototype = modelPrx.prototype;} /*
...
};exports.BindModelInstance = BindModelInstance;let

ModelInstanceProxy = /*#__PURE__*/function (_Proxy2) {_inherits(ModelInstanceProxy, _Proxy2);

  function ModelInstanceProxy(modelInstance) {_classCallCheck(this, ModelInstanceProxy);return _possibleConstructorReturn(this, _getPrototypeOf(ModelInstanceProxy).call(this,
    modelInstance, {
      get: (obj, prop) => {
  ...
  }return ModelInstanceProxy;}(Proxy);exports.ModelInstanceProxy = ModelInstanceProxy;
